...
public class ClassService {
    ...
    public void initializeDummyData() {
        ...
        for (int i = 1; i <= 100; i++) {
            professors.add(new ProfessorEntity((long) i + 1,faker.name().fullName(),faker.number().randomDouble(2, 1, 5),faker.number().randomDouble(2, 1, 5), faker.internet().url(),faker.internet().domainWord()));
        }
